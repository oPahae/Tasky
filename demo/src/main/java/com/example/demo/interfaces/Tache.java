...
public class Tache extends JPanel {
    ...
    private void initializeDemoData() {
        taskData = new TaskData(
                ...
                "Développer et intégrer l'API REST pour la gestion des utilisateurs, incluant l'authentification, les permissions et la validation des données.",
                LocalDate.of(2024, 12, 15),
                LocalDate.of(2024, 11, 20));

        subTasks = new ArrayList<>();
        subTasks.add(new SubTask("Configurer les routes API", true));
        subTasks.add(new SubTask("Implémenter l'authentification JWT", true));
        subTasks.add(new SubTask("Créer les modèles de données", true));
        subTasks.add(new SubTask("Développer les contrôleurs", false));
        subTasks.add(new SubTask("Ajouter la validation des données", false));
        subTasks.add(new SubTask("Écrire les tests unitaires", false));
        ...
        comments.add(new Comment(
                "Alice Martin",
                "Excellent progrès ! L'authentification JWT fonctionne parfaitement.",
                LocalDate.of(2024, 11, 25),
                new Color(99, 102, 241)));
        comments.add(new Comment(
                "Bob Durant",
                "J'ai ajouté la documentation Swagger pour faciliter les tests.",
    ...
    private JPanel createDateCard(String label, LocalDate date, String emoji, Color primaryColor,
        ...
        JPanel card = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // Gradient moderne et vibrant (les cartes colorées restent identiques dans les
                // deux modes)
    ...
    private void addComment(String content) {
        ...
        JOptionPane.showMessageDialog(this, "Commentaire ajouté!", "Succès", JOptionPane.INFORMATION_MESSAGE);
        refreshUI();
    }
